...
// Writes the initial "running" state with the real integer pid (argv[2] == $$ of
// the launch script). Written via temp file + atomic rename so a concurrent
// status reader never observes a torn/partial JSON document.
