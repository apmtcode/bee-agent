...
function shellQuote(value: string): string {
  // POSIX single-quote escaping: each ' becomes '"'"' (close quote, emit an
  // escaped quote via "'", reopen). A value containing a single quote would
  // otherwise break the surrounding quoting and corrupt the rendered script.
