...
// No-op background-task spawner: fake pid, no real subprocess — so the
// launcher's async terminal-state writes never race manual state fixtures.
let noopSpawnPid = 20000;
