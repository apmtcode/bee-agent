...
// Background-task execution state is written explicitly by these tests; a no-op
// spawn keeps them from launching real detached OS processes whose async state
// writes would race with those assertions.
