...
// Deterministic spawn stub: avoid launching a real detached process whose async
// state write would race the manually-driven writeState calls in these tests.
