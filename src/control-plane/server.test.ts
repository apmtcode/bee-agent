...
// Inert background-task spawn: fake pid, no real detached process. Keeps
// background-task state fully test-controlled (via writeState) instead of
// racing with a real launch script's asynchronous state writes.
let inertPid = 90000;
