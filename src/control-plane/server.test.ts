...
// real OS process, so the launch script never races the test's state writes and
// liveness is governed entirely by the injected `backgroundTaskIsProcessRunning`.
