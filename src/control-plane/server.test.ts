...
// Inert background-task spawn: returns a fake pid without launching a real
// worker process, so control-plane assertions that drive execution state
// manually stay deterministic (no async launch script racing them).
let inertPidSeq = 60000;
