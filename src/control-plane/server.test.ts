...
// Deterministic stand-in for the real detached background-task launcher: these
// tests drive task state explicitly, so a real OS process only races with them.
let fakeSpawnPid = 200_000;
