...
function shellQuote(value: string): string {
  ...
  // double-quoted `'`, then reopen — i.e. each `'` becomes `'"'"'`. The prior
  // implementation used `"'"'"'` (an extra leading `"`), which injected stray
  // double quotes and corrupted any command/path containing a single quote.
