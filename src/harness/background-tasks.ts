...
function shellQuote(value: string): string {
  // Wrap in single quotes; escape embedded single quotes via the POSIX
  // close-quote/escaped-quote/reopen idiom ('\'') so commands containing
  // single quotes (e.g. printf 'x') don't corrupt the generated script.
