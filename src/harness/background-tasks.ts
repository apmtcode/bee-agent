...
function shellQuote(value: string): string {
  // POSIX single-quote escape: close the quote, emit an escaped quote, reopen.
  // The previous sequence (`"'"'"'`) was mis-ordered and expanded each `'` to a
  // stray `"'"`, corrupting any single-quoted payload (e.g. JSON commands).
