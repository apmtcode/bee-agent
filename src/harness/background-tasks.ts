...
function shellQuote(value: string): string {
  ...
  // single quote, then reopen — i.e. `'` -> `'"'"'`. A malformed sequence here
  // corrupts the shell-generated state.json for any command containing a single
  // quote, which then fails to parse on recovery.
