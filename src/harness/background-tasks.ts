...
function shellQuote(value: string): string {
  ...
  // apostrophe, then reopen — i.e. ' -> '"'"'. The previous form had a stray
  // leading double-quote ("'"'"') which injected spurious quotes, corrupting
  // both the JSON state payload and any command containing a single quote.
