...
function shellQuote(value: string): string {
  // POSIX single-quote escaping: close the quote, emit an escaped quote via
  // "'", then reopen — i.e. each ' becomes '"'"'. (The previous form started
  // with a " and left the surrounding single quote open, corrupting any value
  // that contained a single quote.)
