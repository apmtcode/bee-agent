...
export type OperatorCliAppOptions = {
  ...
  /**
   * Test seam: inject a fake background-task process spawner / liveness probe so
   * suites don't launch real OS processes whose async state writes race
   * assertions. Defaults to the runtime's real `spawn` in production.
   */
