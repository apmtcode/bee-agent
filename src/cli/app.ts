...
export type OperatorCliAppOptions = {
  ...
  /**
   * Background-task process seams, forwarded to the runtime. Tests inject inert
   * implementations so `startBackgroundTask` never launches a real detached
   * subprocess that would asynchronously mutate task state.
   */
