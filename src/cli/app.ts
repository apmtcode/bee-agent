...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injectable background-task process spawner. Defaults to real detached
   * spawning in production; tests pass a deterministic implementation to avoid
   * racing real subprocesses.
   */
