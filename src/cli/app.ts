...
export type OperatorCliAppOptions = {
  ...
  /**
   * Test seam: inject a stub process spawner / liveness check so background and
   * monitor tasks don't launch real OS processes. Without this, real launch
   * scripts race with a test's manual state writes and leak processes across
   * tests. Left undefined in production so the real spawner is used.
   */
