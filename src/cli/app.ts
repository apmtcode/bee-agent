...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are spawned / probed. Production leaves these
   * undefined (real `spawn` + a live process probe). Tests inject an inert
   * spawn so no real OS process is launched and recovery/sync logic stays
   * deterministic. Forwarded verbatim to the underlying runtime.
   */
