...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are spawned / liveness-checked. Production
   * leaves these undefined (real `spawn` + PID liveness). Tests inject
   * deterministic fakes so suite outcomes don't depend on real subprocess
   * timing.
   */
