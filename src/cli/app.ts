...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are launched / probed. Production uses the
   * real detached-process spawn; hermetic callers (tests, dry-run/simulation
   * mode) inject a simulated spawn so no real subprocess races direct state
   * writes. Forwarded verbatim to the underlying runtime.
   */
