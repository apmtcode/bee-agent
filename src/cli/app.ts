...
export type OperatorCliAppOptions = {
  ...
  configHome?: string;
  /**
   * Background-task process backend. Defaults to the real OS spawn / liveness
   * checks. Tests inject deterministic stubs so no real subprocess is launched
   * and execution state stays under the test's control.
   */
