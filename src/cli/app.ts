...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injectable background-task process seam. Production leaves these unset so the
   * runtime spawns real detached processes; tests inject deterministic stubs so
   * no real process races the state file (mirrors the `configHome` seam).
   */
