...
export type OperatorCliAppOptions = {
  ...
  /**
   * Background-task process seam forwarded to the runtime. Production leaves
   * these undefined (real `spawn` + PID liveness). Tests inject deterministic
   * fakes so status assertions never race a real OS process's async writes.
   */
