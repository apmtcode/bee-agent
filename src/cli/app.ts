...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional injection of the background-task process spawner and liveness
   * check, forwarded to the runtime. Production leaves these undefined (real
   * `spawn`); tests pass deterministic stubs so a real detached process never
   * races with explicitly-driven execution-state scenarios.
   */
