...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are spawned / liveness-checked. Defaults to
   * the real OS process spawn. Tests inject a no-op spawn so the detached
   * launch script never races state files written directly by the test.
   */
