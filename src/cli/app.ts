...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are spawned / probed. Production uses the real
   * `child_process.spawn`; tests inject a no-op spawn so they never leak real
   * detached processes into the temp dir (the source of cleanup/order flakiness).
   */
