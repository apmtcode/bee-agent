...
export type OperatorCliAppOptions = {
  ...
  /**
   * Overrides for the background-task process seams, forwarded to the runtime.
   * Production leaves these unset (real spawn / liveness check); tests inject
   * deterministic stubs so background tasks don't launch real detached
   * processes whose state writes would race assertions.
   */
