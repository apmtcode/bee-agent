...
export type OperatorCliAppOptions = {
  ...
  /**
   * Background-task process seams, forwarded to the runtime. Tests inject these
   * to stay hermetic (no real OS process launch, deterministic liveness) rather
   * than racing real detached processes against manual state writes.
   */
