...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional background-task launch strategy, threaded into the runtime. Lets a
   * host manage process lifecycle out-of-band (e.g. a cloud runtime that cannot
   * detach OS processes) or a test supply a deterministic/inert launcher. When
   * omitted, the runtime spawns a real detached shell as usual.
   */
  backgroundTaskSpawnProcess?: StandaloneOperatorOptions["backgroundTaskSpawnProcess"];
  /** Optional predicate matching {@link OperatorCliAppOptions.backgroundTaskSpawnProcess}. */
