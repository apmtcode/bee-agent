...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional background-task process backend. Production leaves this unset and
   * uses the real detached-process spawner. Tests (and dry-run/offline modes)
   * can inject a simulated backend — see `createSimulatedBackgroundProcess` — to
   * keep task orchestration deterministic and free of real OS side effects.
   */
