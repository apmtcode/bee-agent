...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injection seams for the background-task subsystem, forwarded to the runtime.
   * Production leaves these unset (real process spawning + liveness probing);
   * tests supply stubs so no real OS process is launched and execution state is
   * driven deterministically instead of racing an async launch script.
   */
