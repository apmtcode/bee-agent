...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are spawned / liveness-probed. Production
   * leaves these undefined (real detached processes). Embedders and tests can
   * inject a deterministic executor so task lifecycle is reproducible and does
   * not depend on real OS process timing.
   */
