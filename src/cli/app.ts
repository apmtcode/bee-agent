...
export type OperatorCliAppOptions = {
  ...
  configHome?: string;
  /**
   * Test seam: override how background-task launcher processes are spawned /
   * liveness-probed. Production leaves these undefined (real detached spawn);
   * tests inject deterministic stand-ins so no real OS process is started.
   */
