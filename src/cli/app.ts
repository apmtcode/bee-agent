...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional injectable background-task process hooks, forwarded to the
   * runtime. Production leaves these undefined (real `spawn` / liveness probe).
   * Tests pass mocks so background tasks behave deterministically instead of
   * spawning real detached processes that race with assertions.
   */
