...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional overrides for how background tasks spawn / are liveness-checked.
   * Production leaves these unset (real `child_process.spawn`); tests inject a
   * deterministic mock so no real detached process races the managed state files.
   */
