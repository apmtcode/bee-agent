...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injection seam for the background-task subprocess launcher. Production
   * leaves these undefined (real `spawn` + liveness probe). Tests pass a
   * deterministic fake so background-task state is fully controlled and never
   * races a real detached process.
   */
