...
export type OperatorCliAppOptions = {
   ...
   * internal {@link StandaloneOperatorRuntime}. Primarily used by tests and
   * simulations to run the task lifecycle hermetically (see
   * `createInertBackgroundTaskSpawn`) instead of spawning real OS processes.
   */
