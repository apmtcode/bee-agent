...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional injection seams for the background-task runtime. Production leaves
   * these undefined (real `spawn` / process-liveness checks). Tests inject
   * deterministic fakes so background tasks never spawn real subprocesses that
   * race the assertions.
   */
