...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injection seam for background-task process spawning / liveness. Production
   * leaves these unset (real `spawn` + PID probing); tests pass deterministic
   * stubs so no real detached process is created to race the task state files.
   */
