...
export type OperatorCliAppOptions = {
  ...
  /**
   * Overrides forwarded to the background-task store. Production leaves these
   * unset (real `spawn` / pid probing); tests inject deterministic stubs so a
   * detached launch script cannot race manually-driven execution state.
   */
