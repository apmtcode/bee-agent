...
export type OperatorCliAppOptions = {
  ...
  configHome?: string;
  /**
   * Optional override for how background-task launch scripts are spawned. In
   * production the runtime spawns a real detached process; tests inject an inert
   * spawn so they can drive execution state deterministically via the store.
   */
