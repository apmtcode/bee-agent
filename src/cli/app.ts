...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional overrides for how background tasks spawn/probe OS processes.
   * Production leaves these undefined (real spawn); tests inject deterministic
   * fakes so no real child process writes execution state concurrently.
   */
