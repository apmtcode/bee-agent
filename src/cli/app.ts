...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional injection seam for the background-task launcher. Production leaves
   * these undefined (real `spawn` + liveness probe); tests can pass a no-op
   * spawn so background-task assertions don't depend on real subprocesses.
   */
