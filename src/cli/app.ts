...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injection seams for the background-task execution backend, forwarded to the
   * runtime. Production leaves these undefined (real `spawn` / liveness probe);
   * tests supply deterministic stand-ins so a detached OS process never races
   * to write execution state.
   */
