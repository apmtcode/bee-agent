...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are launched / their liveness is probed.
   * Forwarded to the underlying {@link StandaloneOperatorRuntime}. Tests and
   * dry-run modes can inject `noopSpawnBackgroundProcess` (+ a fixed
   * `isProcessRunning`) to avoid launching real detached OS processes.
   */
