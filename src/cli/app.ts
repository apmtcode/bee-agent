...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are launched / probed. Production uses real
   * detached OS processes; tests inject deterministic stubs so the suite never
   * depends on real process scheduling (mirrors `configHome` isolation).
   */
