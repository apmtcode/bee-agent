...
export type OperatorCliAppOptions = {
   ...
   * undefined (real `child_process.spawn` + a `process.kill(0)` liveness probe).
   * Tests inject deterministic stubs so control-plane assertions never depend on
   * real OS process timing.
   */
