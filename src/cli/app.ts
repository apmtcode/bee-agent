...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional override for how background tasks spawn their launcher process.
   * Production leaves this undefined (real detached spawn); tests inject a
   * deterministic implementation (see `src/harness/background-testing.ts`) to
   * avoid depending on OS scheduling.
   */
