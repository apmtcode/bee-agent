...
export type OperatorCliAppOptions = {
  ...
  /**
   * Overrides for the background-task execution backend. Injected in tests so
   * background-task flows can be driven deterministically without spawning real
   * detached OS processes (which race the launch script's async state writes).
   */
