...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background-task launcher processes are spawned / probed for
   * liveness. Forwarded to the underlying runtime so tests can inject
   * deterministic doubles (see `background-tasks.testkit`) instead of racing a
   * real detached shell. Left undefined in production to use the real spawn.
   */
