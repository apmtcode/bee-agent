...
export type OperatorCliAppOptions = {
   ...
   * real `child_process.spawn`; tests inject a mock so no real OS process is
   * started (which would otherwise race the test's own state writes and leak
   * past temp-dir cleanup).
   */
