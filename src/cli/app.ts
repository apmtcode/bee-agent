...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional injection seams forwarded to the background-task store, primarily
   * for tests that want to drive task state deterministically without spawning
   * a real detached launch script that races the state file.
   */
