...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injectable background-task process spawner. Production uses the default
   * (real `child_process.spawn`); tests supply a deterministic stub so no real
   * detached subprocess races with test-managed state.
   */
