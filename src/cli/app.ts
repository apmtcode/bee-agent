...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background-task processes are spawned / probed. Production uses
   * the defaults (a real detached child); tests inject deterministic stubs so no
   * real process is launched (and the suite is hermetic in cloud/CI).
   */
