...
export type OperatorCliAppOptions = {
  ...
  /**
   * Injectable background-task process seams, forwarded to the runtime. Tests
   * pass mocks so background tasks don't launch real detached subprocesses
   * (whose exit timing makes control/drift assertions nondeterministic).
   */
