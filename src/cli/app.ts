...
export type OperatorCliAppOptions = {
  ...
  /**
   * Test seams for the background-task executor. Production leaves these unset
   * (real process spawn / liveness checks); tests inject deterministic stubs so
   * they never launch real detached OS processes.
   */
