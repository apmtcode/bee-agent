...
export type OperatorCliAppOptions = {
  ...
  /**
   * Optional background-task process seams forwarded to the runtime. Tests
   * inject these to make background-task behaviour hermetic (a deterministic
   * spawn + liveness probe) instead of depending on real OS subprocesses.
   */
