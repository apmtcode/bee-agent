...
export type OperatorCliAppOptions = {
  ...
  /**
   * Test/embedding seams forwarded to the background-task store. Production
   * leaves these undefined so real detached processes are launched; tests inject
   * deterministic stand-ins so a child process never races manual state writes.
   */
