...
export type OperatorCliAppOptions = {
  ...
  /**
   * Testability seam for the background-task subsystem. Injecting a no-op
   * spawner keeps tests hermetic and deterministic — otherwise starting a
   * background task launches a real detached OS subprocess that races the
   * store's state writes and can leak past the test.
   */
