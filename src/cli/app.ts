...
export type OperatorCliAppOptions = {
  ...
  /**
   * Seam for how background/monitor task launch scripts are spawned. Defaults
   * to the real detached `spawn` in production; tests inject a deterministic
   * stub so they never depend on real OS-process timing.
   */
