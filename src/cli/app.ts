...
export type OperatorCliAppOptions = {
  ...
  /**
   * Override how background tasks are launched. Defaults to the runtime's real
   * detached-process launcher; tests inject a deterministic fake so lifecycle
   * assertions don't race a real OS process.
   */
  backgroundTaskSpawnProcess?: StandaloneOperatorOptions["backgroundTaskSpawnProcess"];
  /** Override liveness detection for launched background tasks (see above). */
