...
export type OperatorCliAppOptions = {
  ...
  /**
   * Overrides for how background tasks spawn / are liveness-checked. Production
   * leaves these unset (real detached processes); tests inject deterministic
   * stubs so task execution state is fully controlled instead of racing an
   * out-of-band launch script.
   */
