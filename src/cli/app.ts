...
export type OperatorCliAppOptions = {
   ...
   * Mirrors the options on {@link StandaloneOperatorRuntime}. In production these
   * default to the real `spawn` / process-group probe; tests inject deterministic
   * stand-ins so they never depend on real OS subprocesses or wall-clock timing.
   */
