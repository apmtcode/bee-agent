...
export type OperatorCliAppOptions = {
  ...
  configHome?: string;
  /**
   * Injectable process spawner for background tasks. Defaults to the real
   * `child_process.spawn` in production. Tests should pass a deterministic mock
   * so no detached OS process actually runs and races the test body.
   */
