...
export type OperatorCliAppOptions = {
   ...
   * Production leaves these undefined (real `spawn` + PID liveness checks);
   * tests supply deterministic stubs so the suite never launches real OS
   * processes or depends on subprocess scheduling.
   */
