...
describe("OperatorCliApp", () => {
  it("dispatches status and runtime-backed commands", async () => {
    ...
    const app = new OperatorCliApp({ rootDir, cwd: rootDir, currentDate: "2026-05-25", backgroundTaskSpawnProcess: createInertBackgroundSpawn() });
  ...
  it("shows, configures, and disables the status line command", async () => {
    ...
    const app = new OperatorCliApp({ rootDir, cwd: rootDir, currentDate: "2026-05-25", backgroundTaskSpawnProcess: createInertBackgroundSpawn(), configHome });
  ...
  it("updates the live status line controller when slash commands change config", async () => {
    ...
    stdout.isTTY = true;
    stdout.columns = 80;
    const app = new OperatorCliApp({ rootDir, cwd: rootDir, currentDate: "2026-05-25", backgroundTaskSpawnProcess: createInertBackgroundSpawn(), stdout });
  ...
  it("enters keeps and removes git worktrees", async () => {
    ...
    const notRepoApp = new OperatorCliApp({ rootDir: nonRepoRoot, cwd: nonRepoRoot, currentDate: "2026-05-25", backgroundTaskSpawnProcess: createInertBackgroundSpawn() });
