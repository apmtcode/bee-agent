...
import { fakeSpawnProcess } from "../harness/background-tasks.testkit.js";
...
describe("OperatorCliApp", () => {
  ...
  it("supports background and monitor task commands plus cron commands", async () => {
    ...
    // The fake launcher runs nothing, so the test owns the output the real
    // `printf ok` command would have produced.
