...
import { createDeterministicBackgroundSpawn } from "../harness/background-task-test-spawn.js";
...
describe("OperatorCliApp", () => {
  ...
  it("supports session lifecycle, transcript, approvals, pairing, config, and prompt commands", async () => {
    ...
    const app = new OperatorCliApp({
      ...
      // Keep the launch script from racing the state files this test writes
      // by hand; treat the deliberately-dead sentinel pid (999999) as gone.
