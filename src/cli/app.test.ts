...
// Tests that exercise background/monitor tasks drive their execution state
// deterministically; a no-op spawn keeps them from launching real detached OS
// processes that would race with those writes.
