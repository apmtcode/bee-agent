...
import { createSimulatedBackgroundRuntime } from "../harness/background-tasks.js";
...
describe("OperatorCliApp", () => {
  ...
  it("supports session lifecycle, transcript, approvals, pairing, config, and prompt commands", async () => {
    const rootDir = await makeTempDir();
    const simulatedBackground = createSimulatedBackgroundRuntime();
    const app = new OperatorCliApp({
      rootDir,
      cwd: rootDir,
      currentDate: "2026-05-25",
      backgroundTaskLaunchExecutor: simulatedBackground.launchExecutor,
